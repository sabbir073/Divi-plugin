...
$apiUrl = 'https://screenideaz.com/wp-json/wp/v2/divilayoutlibrary?divilayoutcategory=47&_embed';
...
if ( is_array( $result ) && ! is_wp_error( $result ) ) {
   ...
   $layouts = '';
	...
	foreach( $result as $item ) {
      ...
      $layouts .=  '<div class="theme" tabindex="0" aria-describedby="twentynineteen-action twentynineteen-name" data-slug="twentynineteen">
      ...
      <div class="theme-id-container">
         ...
         <div class="theme-actions">
            <a class="button activate import-layouts" href="#" data-item-type="layout" data-item-title="'.$item-> title->rendered.'" data-download-url="'.$download_url.'" aria-label="Activate Twenty Nineteen">Import</a>
